 ...
 */
export const parseTextContent = (text: string, options: TextParsingOptions = {}): React.ReactElement | null => {
        if (!text) return null;
                        ...
                        {lines.map((line, lineIndex) => (
                                <View key={lineIndex}>
                                        <Text style={textStyle}>
                                                {parseLineContent(line, { onHashtagClick, onMentionClick, onLinkClick, ...options }).map((element, index) => (
