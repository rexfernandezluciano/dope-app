...
const HomePage: React.FC = () => {
	...
	const FeedRoute = useCallback(
		() => (
			<FlatList
				...
				onScroll={scrollAnimation.onScroll}
				scrollEventThrottle={16}
				{...flatListConfig}
			/>
		),
		[feedPosts, renderPost, renderEmptyState, refreshing, onRefresh, flatListConfig, scrollAnimation.onScroll],
	);
	...
	}, [isAuthenticated, followingPosts, renderPost, renderEmptyState, refreshing, onRefresh, flatListConfig, navigation, scrollAnimation.onScroll]);
