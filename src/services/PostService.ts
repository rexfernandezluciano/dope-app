...
class PostService {
        ...
        private static readonly ENDPOINTS = {
                ...
                POST_BY_ID: (postId: string) => `/v1/posts/${postId}`,
        } as const;
         ...
         */
        public async getPostById(postId: string): Promise<PostResponse<Post>> {
                if (!postId) {
                ...
                try {
                        ...
                        const response = await this.client.get<{
                                ...
                                status: string;
                                message?: string;
                        }>(PostService.ENDPOINTS.POST_BY_ID(postId), {}, { headers });
                        ...
                        return this.handleApiError(error, "get post by ID");
                }
        }
}
